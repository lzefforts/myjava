...
/**
 * Created by ArnoldLee on 2019/3/26.
 */
public class MappedByteBufferTest {
    ...
    public static void main(String[] args) {
        ...
        String srcFilePath = "/Users/ArnoldLee/video/12.2分库分表第二课（下）-.mp4";
        String destPath = "/Users/ArnoldLee/video/咕泡学院/12.2分库分表第二课（下）-.mp4";
        /*
        ...
        try (FileChannel in = new FileInputStream(source).getChannel();
            ...
            long copyBetweenTime = copyEndTime - beginTime;
            System.out.println("文件复制耗时为:"+(copyBetweenTime)/1000+"s");
            // System.gc();
            ...
            System.out.println("总过程耗时为:"+(betweenTime)/1000+"s");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
